...
use super::objects::{HeaderKind, PlaylistSidebarKind, SourceObject};
use tracing::debug;
...
/// Build the initial sidebar source list.
///
/// Only the Local, Internet Radio and Playlists sections are created
/// statically. Remote category headers (Subsonic, Jellyfin / Plex, DAAP) are
/// added dynamically when servers are discovered or configured — see
/// `window.rs`.
