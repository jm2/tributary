...
tiers, deduplicates by tier precedence before one stable global distance sort, and retains no
locator in rows or queues. This is
...
slice closes another part of P3.1's compound final record without changing literal arithmetic:
