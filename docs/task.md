...
- [ ] Implement Last.fm authorization and protected secret storage, now-playing/scrobble thresholds,
  ...
  Final validation: locked debug and release suites each pass 20 library, 1,646 application, and 14
  repository-metadata tests (1,680 total). Strict Clippy is green in both profiles, the declared
