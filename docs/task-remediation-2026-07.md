...
- [x] Record implementation: workflow contract implemented in PR #68; the
  ...
  `polecat/tr-qcn` at `c5e9c99e6fcfffd277433de58f340d1e13e9f0ca`.
  "Resolve release source" and "Dry-run tag contract
...
- 2026-09-03 — P0.7's live manual-dispatch acceptance ran after all. The release dry-run
  ...
  (`c5e9c99e6fcfffd277433de58f340d1e13e9f0ca`) requesting tag `v0.6.2` with `dry_run: true`; run
