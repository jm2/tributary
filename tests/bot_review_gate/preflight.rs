...
//! posture, and its fail-closed handling of a malformed manifest and of
//! malformed inventory records (branch-rules references and ruleset rule
//! entries), driven directly from recorded documents. The live stubbed-`gh`
//! reads live in `preflight_live.rs`.
